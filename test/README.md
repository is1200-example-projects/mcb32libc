# Hello libc
Test standard C library functions

## Prerequisites
You need the following to compile and test hello-libc:
...
To watch the printf-output from the board, use a modem terminal like picocom:
